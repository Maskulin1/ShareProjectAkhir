...
class DetailViewModel(application: Application) : ViewModel() {
    ...
    fun checkFavoriteUser(username: String): LiveData<Boolean> {
        return detailUserRepository.checkFavoriteUser(username)
    }

    fun getDataByUsername(username: String): LiveData<UserEntity> {
        Log.d("DetailViewModel", "getDataByUsername called with username: $username")
        return detailUserRepository.getDataByUsername(username)
    }
